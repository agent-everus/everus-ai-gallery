...
const Gallery: React.FC = () => {
  ...
  return (
    <section id="gallery" className="py-28 px-6 max-w-7xl mx-auto">
      ...
      <div className="max-w-2xl mx-auto text-center mb-12 p-8 border border-white/5 bg-white/[0.02]">
        ...
        <p className="text-warm-white/50 text-sm leading-relaxed">
          This gallery is being built to showcase original AI-generated artwork. The works you see now are
          high-quality placeholders. Original pieces — blending generative models, custom training, and
          artistic direction — will be published here as they are completed.
        </p>
      </div>
          ...
          <button
            ...
            className={`px-6 py-2 text-xs tracking-widest uppercase font-light transition-all duration-300 ${
              activeCategory === cat
                ...
                : 'border border-white/10 text-warm-white/50 hover:border-gold/30 hover:text-warm-white'
            }`}
          >
            {cat}
          </button>
